...
Hint: You should see a result like and you can provide an initial value as a third argument:
   ```{python}
   #| echo: false
   #| classes: styled-output
...
In Python the [`Pydantic`](https://docs.pydantic.dev/latest/) package is a widely used data validation library. 
