...
### Variables, Data Types, Functions, Typing and Type Hints, Modules, Decorators
...
For the functions `extimate_pi` and `in_unit_circle` in @exr-montecarlopi1 provide type hints to make sure only `integers` are allowed. 

How can you make sure that the integer is always positive?
::::
:::
