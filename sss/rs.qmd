...
In Python we can use _decorators_ to modify the functionality of a function by wrapping it in another function, you can find introductions in the following links
...
Quite often you want to define the log level via an environment variable.
