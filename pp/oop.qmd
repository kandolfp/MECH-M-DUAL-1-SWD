# Object Oriented Programming {#sec-pp-oop}
...
class Robot:  # <1>
    ...
    def __init__(
        self, name: str, ip: list[int], port: int, speed: float
    ) -> None:  # <2>
...
print(
    f"I am called {r2d2.name}, I can be reached under "
    f"{'.'.join(str(s) for s in r2d2.ip)}"
    f" and my top speed is {r2d2.speed}!"
)
print(
    f"I am called {number5.name}, I can be reached under "
...
class Robot:
    ...
    def introduction(self) -> str:
        ...
        return (
            f"I am called {self.name}, I can be reached under "
