...
lightbox: true
---
# Docker {#sec-container-docker}

:::{.callout-note}
These notes where originally developed for the class _971001 Software_ at the University of Innsbruck and are slightly adapted for this notes. See @pgd2024 for the original source and [github pages](https://kandolfp.github.io/ws22-ulg-python-git-docker/pages/docker/basics) for the notes.
:::
...
Docker uses a specific architecture to achieve this, see @fig-containerization-docker-arch.

::: {#fig-containerization-docker-arch}
![](../_assets/containerization/docker_architecture.svg)
...
This can be public like [Docker Hub](https://hub.docker.com/) and [Quay.io](https://quay.io/)[^1] or private for your organisation and tools like GitLab provide registries as well.

[^1]: A registry from Red Hat
...
:::: {#exm-containerization-docker-gettingstarted}
...
latest: Pulling from jupyter/minimal-notebook   # <1>
6e3729cf69e0: Downloading [=================================>                 ]   20.3MB/30.43MB  # <2>
77950dd14dd3: Download complete # <2>
6cca258439f9: Download complete # <2>
4f4fb700ef54: Download complete # <2>
2e32caa4e229: Download complete # <2>
cd2cab437071: Download complete # <2>
7d6f92933408: Download complete # <2>
e7f578d273e6: Download complete # <2>
b0173d44f264: Downloading [=================>                                 ]  31.78MB/91.89MB   # <2>
bd04425a2ce4: Download complete # <2>
0580703d6738: Downloading [===================>                               ]  11.85MB/30.5MB # <2>
8213e60e2a09: Pulling fs layer # <2>
29e508695ebe: Waiting # <2>
9530616136f0: Waiting # <2>
4ee249fa7dd9: Waiting # <2>
903968ec1329: Waiting # <2>
6cf9a67917c1: Waiting # <2>
2bacb72b4222: Waiting # <2>
 Digest: sha256:109283771021997caa770d367052d5c6ff640a76f8ace0bb3e60d8710fdddd8a # <3>
Status: Downloaded newer image for jupyter/minimal-notebook:latest # <3>
docker.io/jupyter/minimal-notebook:latest # <3>
```
1. When you store an image in a _registry_ it gets a _tag_ or _image id_, where the _tag_ is usually a human readable alias to an _image id_.
...
1. The next lines all look similar.
   An image ID and than the status (Downloading, Download complete, Pulling fs layer, Waiting).  
...
1. Here, and with the additional two lines, the Docker daemon tells us what image was downloaded, from where, and if the download was a success. 
...
::: {.callout-tip appearance="simple" collapse="true" icon=false}
## {{< fa pen-to-square >}} Do you have any idea why?
...
::: {.callout-note}
The Server itself does not know what port you use on your _host machine_ and therefore it will always tell you to connect to `http://127.0.0.1:8888/lab?token=<token>`, unless you tell it to change this.
:::
...
::: {.callout-tip appearance="simple" collapse="true" icon=false}
## {{< fa pen-to-square >}} What happens if we restart the container?
...
::: {.callout-note}
It is important to remember that you are nevertheless inside a container.
...
If your _host user_ is different you can change the user inside the container by adding the option `--user <uid>:<gid>` to the run command.
:::
