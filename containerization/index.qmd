...
filters:
  - highlight-text
---
# Containerization {.unnumbered}

In this section we are going to talk about _containerisation_ but before we can do that let us discuss some common issues in (scientific) computing that will give rise to why containerization is an important issue.
...
Your computer or _physical machine_ is organised approximately like in @fig-containerization-pm.

::: {#fig-containerization-pm}
![](../_assets/containerization/physical_machine.svg)

Organisation of process on a machine.
:::
...
::: {#fig-containerization-vm}
![](../_assets/containerization/virtual_machine.svg)

Organisation of process within a virtual machine.
:::

From the view of the _host_ the entire virtualisation is one (or more) _guest processes_, illustrated above by the [green box]{colour='#2f9e44'}. 

The [_hypervisor_]{colour='#fa5252'} is translating between the _host kernel_ and the virtual hardware that is needed for the [_guest kernel_]{colour='#fa5252'}.
...
::: {#fig-containerization-container}
![](../_assets/containerization/container_machine.svg)

Organisation of process within a container.
:::

You have a specific [_runtime_]{colour='#fa5252'} but not a second kernel. 
...
::: {#fig-containerization-video}

{{< video https://www.youtube.com/embed/8fi7uSYlOdc >}}
