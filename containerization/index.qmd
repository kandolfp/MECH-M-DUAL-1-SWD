...
From the view of the _host_ the entire virtualisation is one (or more) _guest processes_, illustrated above by the green box. 

The _hypervisor_ is translating between the _host kernel_ and the virtual hardware that is needed for the _guest kernel_.
...
You have a specific _runtime_ but not a second kernel. 
