# Dependency and reproducibility {#sec-intro-pm-reproducibility}

Before we conclude our introduction to _package managers_ and _version control_ we would like to share some thoughts on **dependencies** and **reproducibility**.
