...
To a large extent this is also the case for reproducibility of work, your own and the one performed by your code.
Having a properly managed project is a foundation that will help you to achieve this goal more easily.
The whole point of having a proper package management is to be able to copy your project to a new computer and setup your environment as quickly as possible to allow your code to function properly.