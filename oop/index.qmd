...
## Definition of the structure with UML

To get an overview how classes look like and interact Unified Modelling Language (UML) is created.
...
We can model relationships with arrows but most importantly, UML does not show specific objects.
...
```
1. Composition - `University` has an instance of `Deparment`, `Department` cannot exist without `University`
