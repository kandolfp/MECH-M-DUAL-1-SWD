...
The `BaseException` class is the base class for the built-in exceptions [see docs](https://docs.python.org/3/library/exceptions.html) and all the built-in exception are inherited from this class. 
