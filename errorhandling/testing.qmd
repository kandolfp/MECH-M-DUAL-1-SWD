...
```
(@) `dummy/tests/rectangle/__init__.py`
```python
{{< include ../_assets/errorhandling/dummy/tests/rectangle/__init__.py >}}
```
(@) `dummy/tests/rectangle/test_rectangle.py`
```python
{{< include ../_assets/errorhandling/dummy/tests/rectangle/test_rectangle.py >}}
```
:::
